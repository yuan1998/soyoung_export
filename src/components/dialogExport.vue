<template>
    <div class="test">
        <el-button class="float-btn" @click="openDialog" icon="el-icon-s-promotion" circle type="primary"></el-button>
        <el-dialog ref="dialog" title="导出数据" :visible.sync="dialogDisplay" :before-close="handleClose">
            <el-form :model="formData" ref="form" :inline="true" v-loading="loading">
